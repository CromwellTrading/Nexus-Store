// admin.js - Versión completa con depuración
const AdminSystem = {
  productType: 'fisico',
  categoryType: 'fisico',
  isAdmin: false,
  ...
  getAdminPanelHTML: function() {
    ...
    <div class="modal-content" style="max-width: 800px;">
      ...
      <div class="admin-tabs">
        ...
        <button class="admin极速赛车开奖直播官网-tab" data-tab="orders">📋 Pedidos</button>
      </div>
  ...
  editProduct: function(id, type, category) {
    fetch(`${window.API_BASE_URL}/api/products/${type}/${id}`)
      ...
      .then(product => {
        ...
        this.productType = type;
        document.querySelectorAll('.type极速赛车开奖直播官网-tab').forEach(tab => {
